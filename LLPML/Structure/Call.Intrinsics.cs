...
namespace Girl.LLPML
{
    public partial class Call
    {
        ...
        public static void Memcpy(OpModule codes, IIntValue dest, IIntValue src, IIntValue count)
        {
            ...
            codes.Add(I386.Mov(Reg32.ECX, Reg32.EAX));
            codes.Add(I386.And(Reg32.ECX, Val32.New(3)));
            codes.Add(I386.Rep());
        ...
        public static void Memcpy(OpModule codes, IIntValue dest, IIntValue src, int count)
        {
            switch (count)
            {
                ...
                case 1:
                    ...
                    codes.Add(I386.MovB(Reg8.AL, Addr32.New(Reg32.EAX)));
                    codes.Add(I386.MovB(Addr32.New(Reg32.EDX), Reg8.AL));
                    break;
                case 2:
                    dest.AddCodes(codes, "push", null);
                    src.AddCodes(codes, "mov", null);
                    codes.Add(I386.Pop(Reg32.EDX));
                    codes.Add(I386.MovW(Reg16.AX, Addr32.New(Reg32.EAX)));
                    codes.Add(I386.MovW(Addr32.New(Reg32.EDX), Reg16.AX));
                    break;
                case 3:
                    dest.AddCodes(codes, "push", null);
                    src.AddCodes(codes, "mov", null);
                    codes.Add(I386.Pop(Reg32.EDX));
                    codes.Add(I386.MovW(Reg16.CX, Addr32.New(Reg32.EAX)));
                    codes.Add(I386.MovB(Reg8.AL, Addr32.NewRO(Reg32.EAX, 2)));
                    codes.Add(I386.MovW(Addr32.New(Reg32.EDX), Reg16.CX));
                    codes.Add(I386.MovB(Addr32.NewRO(Reg32.EDX, 2), Reg8.AL));
                    break;
                case 4:
                    dest.AddCodes(codes, "push", null);
                    src.AddCodes(codes, "mov", null);
                    ...
                    codes.Add(I386.Mov(Addr32.New(Reg32.EDX), Reg32.EAX));
                    break;
                case 8:
                    dest.AddCodes(codes, "push", null);
                    src.AddCodes(codes, "mov", null);
                    codes.Add(I386.Pop(Reg32.EDX));
                    codes.Add(I386.Mov(Reg32.ECX, Addr32.New(Reg32.EAX)));
                    codes.Add(I386.Mov(Reg32.EAX, Addr32.NewRO(Reg32.EAX, 4)));
                    codes.Add(I386.Mov(Addr32.New(Reg32.EDX), Reg32.ECX));
                    codes.Add(I386.Mov(Addr32.NewRO(Reg32.EDX, 4), Reg32.EAX));
                    break;
                case 12:
                case 16:
                    codes.Add(I386.Pushf());
                ...
                default:
                    ...
                    codes.Add(I386.Pop(Reg32.EDI));
                    codes.Add(I386.Mov(Reg32.ESI, Reg32.EAX));
                    codes.Add(I386.Mov(Reg32.ECX, Val32.NewI((count >> 2))));
                    codes.Add(I386.Cld());
                    codes.Add(I386.Rep());
                    codes.Add(I386.Movsd());
                    if ((count & 3) > 0)
                    {
                        codes.Add(I386.Mov(Reg32.ECX, Val32.NewI((count & 3))));
                        codes.Add(I386.Rep());
                        codes.Add(I386.Movsb());
                    }
                    codes.Add(I386.Pop(Reg32.ESI));
        ...
        public static void MemcpyRev(OpModule codes, IIntValue dest, IIntValue src, IIntValue count)
        {
            ...
            codes.Add(I386.Rep());
            codes.Add(I386.Movsb());
            codes.Add(I386.Sub(Reg32.ESI, Val32.New(3)));
            codes.Add(I386.Sub(Reg32.EDI, Val32.New(3)));
            codes.Add(I386.Mov(Reg32.ECX, Reg32.EAX));
            codes.Add(I386.Shr(Reg32.ECX, 2));
            codes.Add(I386.Rep());
            codes.Add(I386.Movsd());
