    ...
    public partial class I386
    {
        ...
        public static OpCode FromNameW(string op, Reg16 op1, Reg16 op2)
        {
            ...
            switch (op)
            {
                ...
                case "xchg":
                    if (op1 == Reg16.AX)
                        return new OpCode(Util.GetBytes2(0x66, (byte)(0x90 + op2)));
                    else if (op2 == Reg16.AX)
                        return new OpCode(Util.GetBytes2(0x66, (byte)(0x90 + op1)));
                    else
                        b = 0x87;
                    break;
                default:
            ...
            return new OpCode(Util.GetBytes3(0x66, b, (byte)(0xc0 + (((int)op2) << 3) + op1)));
        }
        ...
        public static OpCode FromNameW(string op, Reg16 op1, Addr32 op2)
        {
            ...
            switch (op)
            {
                case "mov":
                    if (op1 == Reg16.AX && op2.IsAddress)
                        return new OpCode(Util.GetBytes2(0x66, 0xa1), op2.Address);
                    b = 0x8b;
                    break;
                case "xchg":
                    b = 0x87;
            ...
            return new OpCode(Util.GetBytes2(0x66, b), null, Addr32.NewAdM(op2, (byte)op1));
        }
        ...
        public static OpCode FromNameW(string op, Addr32 op1, Reg16 op2)
        {
            ...
            switch (op)
            {
                case "mov":
                    if (op2 == Reg16.AX && op1.IsAddress)
                        return new OpCode(Util.GetBytes2(0x66, 0xa3), op1.Address);
                    b = 0x89;
                    break;
                case "test":
                    b = 0x85;
            ...
            return new OpCode(Util.GetBytes2(0x66, b), null, Addr32.NewAdM(op1, (byte)op2));
        }
        ...
        public static OpCode FromNameW(string op, Addr32 op1, ushort op2)
        {
            ...
            {
                case "mov":
                    return new OpCode(Util.GetBytes2(0x66, 0xc7), op2, op1);
                case "test":
                    return new OpCode(Util.GetBytes2(0x66, 0xf7), op2, op1);
                default:
                    int code = GetOperatorCode(op);
                    if (code < 0) throw new Exception("invalid operator: " + op);
                    return new OpCode(Util.GetBytes2(0x66, 0x81), op2, Addr32.NewAdM(op1, (byte)code));
            }
        }
    }
}
