...
namespace Girl.X86
{
    public partial class I386
    {
        ...
        public static OpCode ShiftW(string op, Reg16 op1, byte op2)
        {
            ...
            if (op2 == 1)
                return new OpCode(Util.GetBytes3(0x66, 0xd1, b));
            else
                return new OpCode(Util.GetBytes3(0x66, 0xc1, b), op2);
        }
        ...
        public static OpCode ShiftW(string op, Reg16 op1, Reg8 op2)
        {
            ...
            if (op2 != Reg8.CL)
                ...
                return new OpCode(Util.GetBytes3(0x66, 0xd3, b));
        }
        ...
        public static OpCode ShiftW(string op, Addr32 op1, byte op2)
        {
            ...
            if (op2 == 1)
                return new OpCode(Util.GetBytes2(0x66, 0xd1), null, ad);
            else
                return new OpCode(Util.GetBytes2(0x66, 0xc1), op2, ad);
        }
        ...
        public static OpCode ShiftW(string op, Addr32 op1, Reg8 op2)
        {
            ...
            if (op2 != Reg8.CL)
                ...
                return new OpCode(Util.GetBytes2(0x66, 0xd3), null, ad);
        }
    }
}
