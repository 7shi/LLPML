...
namespace Girl.X86
{
    public partial class I386
    {
        public static void TestShift_16()
        {
            ...
            ShlW(Addr32.NewRO(Reg32.EBP, 4), 1)
                .Test("shl word [ebp+4], 1", "66-D1-65-04");
            ShlW(Addr32.NewRO(Reg32.EBP, 4), Reg8.CL)
                .Test("shl word [ebp+4], cl", "66-D3-65-04");
            ShlW(Addr32.NewRO(Reg32.EBP, 4), 8)
            ...
            ShrW(Addr32.NewRO(Reg32.EBP, 4), 1)
                .Test("shr word [ebp+4], 1", "66-D1-6D-04");
            ShrW(Addr32.NewRO(Reg32.EBP, 4), Reg8.CL)
                .Test("shr word [ebp+4], cl", "66-D3-6D-04");
            ShrW(Addr32.NewRO(Reg32.EBP, 4), 8)
            ...
            SalW(Addr32.NewRO(Reg32.EBP, 4), 1)
                .Test("sal word [ebp+4], 1", "66-D1-65-04");
            SalW(Addr32.NewRO(Reg32.EBP, 4), Reg8.CL)
                .Test("sal word [ebp+4], cl", "66-D3-65-04");
            SalW(Addr32.NewRO(Reg32.EBP, 4), 8)
            ...
            SarW(Addr32.NewRO(Reg32.EBP, 4), 1)
                .Test("sar word [ebp+4], 1", "66-D1-7D-04");
            SarW(Addr32.NewRO(Reg32.EBP, 4), Reg8.CL)
                .Test("sar word [ebp+4], cl", "66-D3-7D-04");
            SarW(Addr32.NewRO(Reg32.EBP, 4), 8)
