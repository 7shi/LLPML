...
namespace Girl.X86
{
    ...
    {
        public static OpCode MovD(Xmm op1, Reg32 op2) { return FromName("movd", op1, op2); }
        public static OpCode MovD(Xmm op1, Addr32 op2) { return FromName("movd", op1, op2); }
        public static OpCode MovD(Reg32 op1, Xmm op2) { return FromName("movd", op1, op2); }
        public static OpCode MovD(Addr32 op1, Xmm op2) { return FromName("movd", op1, op2); }

        public static OpCode MovQ(Xmm op1, Xmm op2) { return FromName("movq", op1, op2); }
        public static OpCode MovQ(Xmm op1, Addr32 op2) { return FromName("movq", op1, op2); }
        ...
        public static OpCode MovDQA(Addr32 op1, Xmm op2) { return FromName("movdqa", op1, op2); }

        public static OpCode MovDQU(Xmm op1, Xmm op2) { return FromName("movdqu", op1, op2); }
        public static OpCode MovDQU(Xmm op1, Addr32 op2) { return FromName("movdqu", op1, op2); }
        ...
        public static OpCode PAddB(Xmm op1, Addr32 op2) { return FromName("paddb", op1, op2); }
        ...
        public static OpCode PAddD(Xmm op1, Addr32 op2) { return FromName("paddd", op1, op2); }
        public static OpCode PAddQ(Xmm op1, Xmm op2) { return FromName("paddq", op1, op2); }
        public static OpCode PAddQ(Xmm op1, Addr32 op2) { return FromName("paddq", op1, op2); }

        public static OpCode PSubB(Xmm op1, Xmm op2) { return FromName("psubb", op1, op2); }
        public static OpCode PSubB(Xmm op1, Addr32 op2) { return FromName("psubb", op1, op2); }
        ...
        public static OpCode PSubD(Xmm op1, Addr32 op2) { return FromName("psubd", op1, op2); }
        public static OpCode PSubQ(Xmm op1, Xmm op2) { return FromName("psubq", op1, op2); }
        public static OpCode PSubQ(Xmm op1, Addr32 op2) { return FromName("psubq", op1, op2); }

        public static OpCode PMulHW(Xmm op1, Xmm op2) { return FromName("pmulhw", op1, op2); }
        public static OpCode PMulHW(Xmm op1, Addr32 op2) { return FromName("pmulhw", op1, op2); }
        ...
        public static OpCode PSLLW(Xmm op1, byte op2) { return FromName("psllw", op1, op2); }
        public static OpCode PSLLD(Xmm op1, Xmm op2) { return FromName("pslld", op1, op2); }
        public static OpCode PSLLD(Xmm op1, Addr32 op2) { return FromName("pslld", op1, op2); }
        public static OpCode PSLLD(Xmm op1, byte op2) { return FromName("pslld", op1, op2); }
        public static OpCode PSLLQ(Xmm op1, Xmm op2) { return FromName("psllq", op1, op2); }
        public static OpCode PSLLQ(Xmm op1, Addr32 op2) { return FromName("psllq", op1, op2); }
        ...
        public static OpCode PSRLW(Xmm op1, Addr32 op2) { return FromName("psrlw", op1, op2); }
        ...
        public static OpCode PSRLD(Xmm op1, Addr32 op2) { return FromName("psrld", op1, op2); }
        public static OpCode PSRLD(Xmm op1, byte op2) { return FromName("psrld", op1, op2); }
        ...
        public static OpCode PSRLQ(Xmm op1, byte op2) { return FromName("psrlq", op1, op2); }
        ...
        public static OpCode PSRAW(Xmm op1, byte op2) { return FromName("psraw", op1, op2); }
        public static OpCode PSRAD(Xmm op1, Xmm op2) { return FromName("psrad", op1, op2); }
        public static OpCode PSRAD(Xmm op1, Addr32 op2) { return FromName("psrad", op1, op2); }
        ...
        public static OpCode PUnpckHBW(Xmm op1, Addr32 op2) { return FromName("punpckhbw", op1, op2); }
        public static OpCode PUnpckHWD(Xmm op1, Xmm op2) { return FromName("punpckhwd", op1, op2); }
        public static OpCode PUnpckHWD(Xmm op1, Addr32 op2) { return FromName("punpckhwd", op1, op2); }
        ...
        public static OpCode PUnpckLBW(Xmm op1, Addr32 op2) { return FromName("punpcklbw", op1, op2); }
        ...
        public static OpCode PUnpckLDQ(Xmm op1, Addr32 op2) { return FromName("punpckldq", op1, op2); }

        public static OpCode PackSSWB(Xmm op1, Xmm op2) { return FromName("packsswb", op1, op2); }
        public static OpCode PackSSWB(Xmm op1, Addr32 op2) { return FromName("packsswb", op1, op2); }
