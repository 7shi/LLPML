...
namespace Girl.X86
{
    public partial class I386
    {
        public static void Test2_32()
        {
            ...
            // Mov
            Mov(Reg32.EAX, Val32.New(4))
                .Test("mov eax, 4", "B8-04-00-00-00");
            Mov(Reg32.ESP, Val32.New(4))
            ...
            // Add
            Add(Reg32.EAX, Val32.New(4))
                .Test("add eax, 4", "05-04-00-00-00");
            Add(Reg32.ESP, Val32.New(4))
            ...
            // Or
            Or(Reg32.EAX, Val32.New(4))
                .Test("or eax, 4", "0D-04-00-00-00");
            Or(Reg32.ESP, Val32.New(4))
            ...
            // Adc
            Adc(Reg32.EAX, Val32.New(4))
                .Test("adc eax, 4", "15-04-00-00-00");
            Adc(Reg32.ESP, Val32.New(4))
            ...
            // Sbb
            Sbb(Reg32.EAX, Val32.New(4))
                .Test("sbb eax, 4", "1D-04-00-00-00");
            Sbb(Reg32.ESP, Val32.New(4))
            ...
            // And
            And(Reg32.EAX, Val32.New(4))
                .Test("and eax, 4", "25-04-00-00-00");
            And(Reg32.ESP, Val32.New(4))
            ...
            // Sub
            Sub(Reg32.EAX, Val32.New(4))
                .Test("sub eax, 4", "2D-04-00-00-00");
            Sub(Reg32.ESP, Val32.New(4))
            ...
            // Xor
            Xor(Reg32.EAX, Val32.New(4))
                .Test("xor eax, 4", "35-04-00-00-00");
            Xor(Reg32.ESP, Val32.New(4))
            ...
            // Cmp
            Cmp(Reg32.EAX, Val32.New(4))
                .Test("cmp eax, 4", "3D-04-00-00-00");
            Cmp(Reg32.ESP, Val32.New(4))
            ...
            // Test
            Test(Reg32.EAX, Val32.New(4))
                .Test("test eax, 4", "A9-04-00-00-00");
            Test(Reg32.ESP, Val32.New(4))
